...
public class Upgrade {
    ...
    public void open(Player player) {
        ...
        if (playerDataManager.hasPlayerData(player) && playerDataManager.getPlayerData(player).getViewer() != null) {
            ...
            if (viewer == null || viewer.getType() == Upgrade.Viewer.Type.UPGRADES) {
                nInventoryUtil nInv = new nInventoryUtil(player, event -> {
                    ...
                    if ((is.getType() == XMaterial.OAK_FENCE_GATE.parseMaterial()) && (is.hasItemMeta())
                        ...
                        if (is.getItemMeta().getDisplayName().equals(plugin.formatText(
                            ...
                            upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SPEED)
                                    .get(0);
                            viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.SPEED);
                            ...
                            upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.JUMP)
                                    .get(0);
                            viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.JUMP);
                        }
                        ...
                        upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.CROP)
                                .get(0);
                        viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.CROP);
                    } else if ((is.getType() == Material.FEATHER) && (is.hasItemMeta())
                            && (is.getItemMeta().getDisplayName().equals(plugin.formatText(
                            configLoad.getString("Menu.Admin.Upgrade.Upgrades.Item.Fly.Displayname"))))) {
                        upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.FLY)
                                .get(0);
                        viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.FLY);
                        ...
                        upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.DROPS)
                                .get(0);
                        viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.DROPS);
                        ...
                        viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE);
                        ...
                        viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS);
                        ...
                        upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SPAWNER)
                                .get(0);
                        viewer.setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.SPAWNER);
                    }
                    ...
                    if (upgrade != null) {
                        if (event.getClick() == ClickType.LEFT) {
                            ...
                            if (playerDataManager.hasPlayerData(player)) {
                                com.craftaro.skyblock.upgrade.Upgrade.Type upgradeType = ((Viewer) playerDataManager
                ...
                upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SPEED).get(0);
                ...
                upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.JUMP).get(0);
                ...
                upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.FLY).get(0);
                ...
                upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.DROPS).get(0);
                ...
                // Size
                List<com.craftaro.skyblock.upgrade.Upgrade> upgradesSize = upgradeManager
                        .getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE);
                ...
                // Members
                List<com.craftaro.skyblock.upgrade.Upgrade> upgradesMembers = upgradeManager
                ...
                upgrade = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SPAWNER).get(0);
                ...
                nInventoryUtil nInv = new nInventoryUtil(player, event -> {
                    ...
                    if (playerDataManager.hasPlayerData(player)) {
                        ...
                        if ((is.getType() == XMaterial.OAK_FENCE_GATE.parseMaterial()) && (is.hasItemMeta())
                                            ...
                                            gui.setAction(event1 -> {
                                                ...
                                                if (playerDataManager.hasPlayerData(player)
                                                    ...
                                                    if (!gui.getInputText().matches("[0-9]+")) {
                                                        ...
                                                        List<com.craftaro.skyblock.upgrade.Upgrade> upgrades1 = upgradeManager
                                                                .getUpgrades(
                                                    ...
                                                    upgradeManager.addUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE, size);
                            ...
                            com.craftaro.skyblock.upgrade.Upgrade upgrade = upgradeManager
                                    .getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE).get(tier);
                            ...
                            if (upgrade != null) {
                                if (event.getClick() == ClickType.LEFT) {
                                                ...
                                                gui.setAction(event1 -> {
                                                    ...
                                                    if (playerDataManager.hasPlayerData(player)
                                                        ...
                                                        if (!gui.getInputText().matches("[0-9]+")) {
                                                            ...
                                                            return;
                                                        } else if (upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE).get(tier) == null) {
                                                            messageManager.sendMessage(player,
                                                                    configLoad.getString(
                                                        ...
                                                        soundManager.playSound(player, XSound.BLOCK_ANVIL_USE);
                                                        upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE).get(tier).setValue(size);
                                                        fileManager
                                    ...
                                    upgradeManager.removeUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE,
                                            ...
                                            () -> {
                                                ...
                                                gui.setAction(event1 -> {
                                                    ...
                                                    if (playerDataManager.hasPlayerData(player)
                                                        ...
                                                        soundManager.playSound(player, XSound.BLOCK_ANVIL_USE);
                                                        upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.SIZE).get(tier).setCost(cost);
                                                        fileManager
                                                                .getConfig(new File(plugin.getDataFolder(), "upgrades.yml"))
                                                                .getFileConfiguration()
                ...
                nInventoryUtil nInv = new nInventoryUtil(player, event -> {
                    ...
                    if (playerDataManager.hasPlayerData(player)) {
                        ...
                        if ((is.getType() == XMaterial.OAK_FENCE_GATE.parseMaterial()) && (is.hasItemMeta())
                                            ...
                                            gui.setAction(event1 -> {
                                                ...
                                                if (playerDataManager.hasPlayerData(player)
                                                    ...
                                                    if (!gui.getInputText().matches("[0-9]+")) {
                                                        ...
                                                        List<com.craftaro.skyblock.upgrade.Upgrade> upgrades1 = upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS);
                                                    ...
                                                    soundManager.playSound(player, XSound.BLOCK_ANVIL_USE);
                                                    upgradeManager.addUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS, size);
                            ...
                            com.craftaro.skyblock.upgrade.Upgrade upgrade = upgradeManager
                                    .getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS).get(tier);
                            ...
                            if (upgrade != null) {
                                if (event.getClick() == ClickType.LEFT) {
                                                ...
                                                gui.setAction(event1 -> {
                                                    ...
                                                    if (playerDataManager.hasPlayerData(player)
                                                        ...
                                                        if (!gui.getInputText().matches("[0-9]+")) {
                                                            ...
                                                            return;
                                                        } else if (upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS).get(tier) == null) {
                                                        ...
                                                        soundManager.playSound(player, XSound.BLOCK_ANVIL_USE);
                                                        upgradeManager.getUpgrades(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS).get(tier).setValue(size);
                                                        fileManager
                                                                .getConfig(new File(plugin.getDataFolder(), "upgrades.yml"))
                                                                .getFileConfiguration()
                                    ...
                                    soundManager.playSound(player, XSound.ENTITY_IRON_GOLEM_ATTACK);
                                    upgradeManager.removeUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type.MEMBERS,
                                            upgrade.getCost(), upgrade.getValue());
                                } else if (event.getClick() == ClickType.RIGHT) {
                                    soundManager.playSound(player, XSound.BLOCK_WOODEN_BUTTON_CLICK_ON);
    ...
    public static class Viewer {
        private Type type;
        private com.craftaro.skyblock.upgrade.Upgrade.Type upgrade;

        public Viewer(Type type, com.craftaro.skyblock.upgrade.Upgrade.Type upgrade) {
            this.type = type;
        ...
        public com.craftaro.skyblock.upgrade.Upgrade.Type getUpgrade() {
            return this.upgrade;
        }

        public void setUpgrade(com.craftaro.skyblock.upgrade.Upgrade.Type upgrade) {
            this.upgrade = upgrade;
        }
