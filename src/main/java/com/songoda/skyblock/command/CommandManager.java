...
import com.songoda.skyblock.command.commands.admin.CreateCommand;
import com.songoda.skyblock.command.commands.admin.DeleteCommand;
import com.songoda.skyblock.command.commands.admin.GeneratorCommand;
import com.songoda.skyblock.command.commands.admin.LevelCommand;
import com.songoda.skyblock.command.commands.admin.LevelScanCommand;
import com.songoda.skyblock.command.commands.admin.OwnerCommand;
...
import com.songoda.skyblock.command.commands.admin.SetSpawnCommand;
import com.songoda.skyblock.command.commands.admin.SettingsCommand;
...
import com.songoda.skyblock.command.commands.admin.UpgradeCommand;
...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public void registerSubCommands() {
        this.islandCommands = Arrays.asList(
                ...
                new com.songoda.skyblock.command.commands.island.CreateCommand(this.plugin),
                new CurrentCommand(this.plugin),
                new com.songoda.skyblock.command.commands.island.DeleteCommand(this.plugin),
                ...
                new com.songoda.skyblock.command.commands.island.LevelCommand(this.plugin),
                new MembersCommand(this.plugin),
                new OpenCommand(this.plugin),
                new com.songoda.skyblock.command.commands.island.OwnerCommand(this.plugin),
                new PreviewCommand(this.plugin),
                new PromoteCommand(this.plugin),
                new PublicCommand(this.plugin),
                new com.songoda.skyblock.command.commands.island.SetSpawnCommand(this.plugin),
                new com.songoda.skyblock.command.commands.island.SettingsCommand(this.plugin),
                new TeleportCommand(this.plugin),
                new UnbanCommand(this.plugin),
                new UnlockCommand(this.plugin),
                new com.songoda.skyblock.command.commands.island.UpgradeCommand(this.plugin),
